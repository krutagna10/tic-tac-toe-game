        ...
        <div className="choice__form-control background-semi-dark flow">
          ...
          <Flex className="choice__input-wrapper">
            <input
              ...
              aria-label="Select x as your mark"
            />
            <label
            ...
            <input
              ...
              aria-label="Select o as your mark"
            />
            <label
          ...
          <p className="choice__form-text font-size-100">
            Remember: X goes first
          </p>
        </div>
        <Button type="submit" className="choice__btn btn--yellow font-size-300">
          New Game (vs CPU)
        </Button>
      </form>
    </div>
